...
레퍼런스 대본의 각 문장에서 사람마다 달라지는 핵심 단어만 [태그] 형식으로 치환해서 템플릿을 만들어줘.
...
=== 태그 치환 핵심 규칙 ===
1. 문장당 태그 최대 1~2개 (더 많으면 채우기 어렵고 의미가 흐려짐)
2. 감탄사·접속사·리액션·구조 자체가 핵심인 문장 → 태그 없이 그대로
   예) "드디어 찾았어요", "이게 뭐냐구요?", "심지어", "잖아" → 수정 금지
3. 사람마다 달라지는 핵심 단어만 태그: 상품명, 타겟, 특징, 가격, 문제점, 결과 등
4. 태그명: 역할을 나타내는 2~6자 (예: 상품명, 타겟, 핵심특징, 문제점, 장점, 가격대, CTA키워드, 혜택, 검증아이템, 평가결과)
5. 같은 태그 여러 줄에 재사용 가능
